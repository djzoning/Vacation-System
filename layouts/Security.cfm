...
<html lang="en">
    ...
    <head>
        ...
        <link href="/includes/theme/assets/global/plugins/select2/css/select2-bootstrap.min.css" rel="stylesheet" type="text/css" />
        ...
        <link href="/includes/theme/assets/pages/css/login.min.css" rel="stylesheet" type="text/css" />
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="">
            	<img src="/includes/images/logo-13bik_179x93.png" alt="" /> 
            </a>
        </div>
        <!-- END LOGO -->
        ...
        <!-- END CORE PLUGINS -->
        <!-- BEGIN PAGE LEVEL PLUGINS -->
        <script src="/includes/theme/assets/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
        <script src="/includes/theme/assets/global/plugins/jquery-validation/js/additional-methods.min.js" type="text/javascript"></script>
        ...
        <script src="/includes/theme/assets/pages/scripts/login.min.js" type="text/javascript"></script>
