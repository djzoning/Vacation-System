<html lang="en"><!--<![endif]--><!-- BEGIN HEAD --><head>
        ...
        <link href="/includes/theme/assets/pages/css/error.min.css" rel="stylesheet" type="text/css">
    ...
    <body class=" page-404-3" cz-shortcut-listen="true">
        <div class="page-inner">
            <img src="/includes/theme/assets/pages/media/pages/earth.jpg" class="img-responsive" alt=""> </div>
